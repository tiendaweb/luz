...
if ($method === 'GET') {
    ...
    $items = api_attendance_list($pdo, ['role' => 'associate', 'id' => $associateId], $forumId, $registrationId);
...
if ($method === 'POST' || $method === 'PATCH') {
    ...
    if (!api_attendance_can_manage($pdo, $registrationId, $forumId, ['role' => 'associate', 'id' => $associateId])) {
    ...
    $stmt->execute([
        ...
        'recorded_by_user_id' => $associateId,
