    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div>
                ...
                <div class="prose prose-slate space-y-4 text-slate-600">
                    ...
                    <div class="bg-teal-50 border-l-4 p-6 rounded-lg mt-8" style="border-color: var(--brand-primary);">
                        <p class="font-bold text-slate-900 mb-4 flex items-center gap-2">
                            <i class="fa-solid fa-phone" style="color: var(--brand-primary);"></i> Contacto
                        </p>
        ...
        <div class="bg-white rounded-3xl p-10 shadow-xl border border-slate-100 max-w-2xl mx-auto">
            ...
            <form id="consultaForm" class="space-y-6" novalidate>
                ...
                <button type="submit" class="w-full text-white font-extrabold py-4 rounded-2xl transition-all shadow-xl shadow-teal-100" style="background-color: var(--brand-primary);">
