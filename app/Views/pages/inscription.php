            ...
            <form id="registerForm" class="space-y-6" novalidate>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input name="email" type="email" placeholder="tu@email.com" class="w-full bg-slate-100 border-none rounded-xl p-4 font-medium focus:ring-2 focus:ring-teal-500" required>
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2">Contraseña *</label>
                        <input name="password" type="password" placeholder="Mínimo 6 caracteres" class="w-full bg-slate-100 border-none rounded-xl p-4 font-medium focus:ring-2 focus:ring-teal-500" required minlength="6">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2">Nombre y Apellidos *</label>
                        <input name="fullName" type="text" placeholder="Como figurará en certificado" class="w-full bg-slate-100 border-none rounded-xl p-4 font-medium focus:ring-2 focus:ring-teal-500" required>
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-slate-700 mb-2">DNI / Documento *</label>
                        <input name="documentId" type="text" placeholder="Nº identificación" class="w-full bg-slate-100 border-none rounded-xl p-4 font-medium focus:ring-2 focus:ring-teal-500" required>
                    </div>
                    <div class="col-span-1 md:col-span-2">
                        <label class="block text-sm font-bold text-slate-700 mb-2">¿Requieres Certificación con Aval? *</label>
                        <div class="flex gap-6 mt-2">
                            <label class="flex items-center gap-3 cursor-pointer">
                                <input type="radio" name="certif" value="no" class="w-5 h-5 text-teal-600 focus:ring-teal-500" checked onchange="toggleCertFields(false)">
                                <span class="font-bold text-slate-700">No</span>
                            </label>
                            <label class="flex items-center gap-3 cursor-pointer">
                                <input type="radio" name="certif" value="yes" class="w-5 h-5 text-teal-600 focus:ring-teal-500" onchange="toggleCertFields(true)">
                ...
                <div class="bg-yellow-50 p-6 rounded-3xl border-l-4 border-yellow-400">
                    ...
                    <label class="flex items-center gap-3">
                        <input id="acceptanceCheck" name="acceptanceCheck" type="checkbox" class="w-5 h-5 rounded text-teal-600" required>
                ...
                <button type="submit" class="w-full bg-teal-600 text-white font-extrabold py-5 rounded-2xl text-lg hover:bg-teal-700 transition-all shadow-xl shadow-teal-100">
