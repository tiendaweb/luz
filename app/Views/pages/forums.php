                ...
                <div class="bg-slate-900 rounded-3xl p-8 text-white sticky top-32">
                    ...
                    <div class="space-y-3 mb-8">
                        <div class="flex justify-between">
                            ...
                            <span class="font-bold text-teal-400">$35.000</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-slate-300">Estudiantes</span>
                            <span class="font-bold text-teal-400">$20.000</span>
                        </div>
                        <div class="flex justify-between border-t border-slate-700 pt-3 mt-3">
                            <span class="text-slate-300">Promo grupal</span>
                            <span class="font-bold text-teal-400">20% OFF</span>
                        </div>
                    </div>
                    <a href="/inscripcion" class="w-full bg-teal-600 text-white font-extrabold py-4 rounded-2xl hover:bg-teal-700 transition-all shadow-xl shadow-teal-500/30 flex items-center justify-center">
                        Inscribirse Ahora
                    </a>
                </div>
            </div>
