...
<section class="py-24">
 ...
 <div id="userInitial" class="w-16 h-16 rounded-full btn-primary flex items-center justify-center text-2xl font-extrabold mb-4">U</div>
 <h3 id="userName" class="text-lg font-bold text-slate-900">Usuario</h3>
 <div id="userRoleBadge" class="mt-2 px-3 py-1 rounded-full bg-teal-100 text-brand text-xs font-bold uppercase">Usuario</div>
 </div>
