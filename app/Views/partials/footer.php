...
// $siteSettings may not be in scope when included from render_main_layout (function scope).
...
?>
 ...
 <div class="w-10 h-10 rounded-lg flex items-center justify-center text-white font-bold mr-3 shadow-lg rotate-3" style="background-color: var(--color-accent);">
 ...
 <p class="text-sm font-bold mb-4 uppercase tracking-widest" style="color: var(--color-accent);">Bajo la dirección de <?= htmlspecialchars($directorName, ENT_QUOTES, 'UTF-8') ?></p>
 ...
 <a href="#" class="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center border border-slate-800 hover:border-[var(--color-accent)] transition-all"><i class="fa-brands fa-instagram"></i></a>
 <a href="#" class="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center border border-slate-800 hover:border-[var(--color-accent)] transition-all"><i class="fa-brands fa-linkedin"></i></a>
 <a href="#" class="w-10 h-10 rounded-full bg-slate-900 flex items-center justify-center border border-slate-800 hover:border-[var(--color-accent)] transition-all"><i class="fa-brands fa-whatsapp"></i></a>
 </div>
 </div>
 <div>
 <h4 class="font-bold mb-6 uppercase tracking-widest text-sm" style="color: var(--color-accent);">Foros</h4>
 ...
 <div>
 <h4 class="font-bold mb-6 uppercase tracking-widest text-sm" style="color: var(--color-accent);"><?= htmlspecialchars($directorName, ENT_QUOTES, 'UTF-8') ?></h4>
 <ul class="space-y-4 text-slate-400">
