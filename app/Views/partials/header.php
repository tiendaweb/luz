        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="/" class="text-sm font-semibold hover:text-teal-600 transition-colors">Inicio</a>
                    <a href="/foros" class="text-sm font-semibold hover:text-teal-600 transition-colors">Foros y Agenda</a>
                    <a href="/directora" class="text-sm font-semibold hover:text-teal-600 transition-colors">La Directora</a>
                    <a href="/blog" class="text-sm font-semibold hover:text-teal-600 transition-colors">Blog</a>

                    <?php if ($_viewIsLoggedIn): ?>
                    <a href="/dashboard" class="user-access-btn bg-slate-900 text-white px-5 py-2.5 rounded-full text-sm font-bold hover:bg-teal-700 transition-all flex items-center gap-2">
