...
<main class="relative min-h-screen overflow-hidden py-10 px-4 sm:px-6 lg:px-8">
  <div class="absolute -top-24 -left-24 w-72 h-72 rounded-full bg-amber-100 blur-3xl opacity-80"></div>
  ...
  <div class="relative mx-auto w-full max-w-5xl grid gap-8 lg:grid-cols-2 items-stretch">
    <section class=”hidden lg:flex rounded-3xl bg-gradient-to-br from-amber-800 to-amber-700 text-white p-10 flex-col justify-between shadow-2xl”>
      <div>
        <p class=”uppercase tracking-[0.2em] text-xs font-bold text-amber-50”>Foros LATAM PSME</p>
        <h1 class=”mt-4 text-4xl font-extrabold leading-tight”>Ingreso al área de gestión y seguimiento.</h1>
        <p class=”mt-4 text-amber-50 text-lg”>Accede con tus credenciales para ver panel, actividad e inscripciones.</p>
      </div>
      <div class=”rounded-2xl bg-white/15 border border-white/30 p-5 backdrop-blur-sm”>
        ...
        <p class=”mt-2 text-sm text-amber-50”>Usa “Autocompletar credenciales de prueba” para cargar perfiles demo en un clic.</p>
      </div>
    </section>

    <section class="rounded-3xl bg-white border border-slate-200 shadow-xl p-6 sm:p-10">
      <div class="mb-8">
        <p class="text-sm uppercase tracking-widest text-amber-800 font-bold">Acceso Seguro</p>
      ...
      <form id="loginForm" class="space-y-5" novalidate>
        <div>
          ...
          <input id="username" name="username" type="text" autocomplete="username" required
            class="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 text-slate-900 focus:border-amber-500 focus:outline-none focus:ring-2 focus:ring-amber-100"
        ...
        <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
          ...
          <div class="grid gap-2 sm:grid-cols-3">
            <button type="button" data-demo-role="admin"
              class="rounded-xl border border-amber-200 bg-white px-3 py-3 text-sm font-semibold
                     text-amber-800 hover:bg-amber-50 hover:border-amber-400 transition text-left">
              <i class="fa-solid fa-shield-halved block mb-1 text-amber-800"></i>
              Admin (Luz)
            </button>
            <button type="button" data-demo-role="associate"
              class="rounded-xl border border-amber-200 bg-white px-3 py-3 text-sm font-semibold
                     text-amber-800 hover:bg-amber-50 hover:border-amber-400 transition text-left">
              <i class="fa-solid fa-users block mb-1 text-amber-700"></i>
              Asociado
            </button>
            <button type="button" data-demo-role="user"
              class="rounded-xl border border-yellow-200 bg-white px-3 py-3 text-sm font-semibold
                     text-yellow-800 hover:bg-yellow-50 hover:border-yellow-400 transition text-left">
              <i class="fa-solid fa-user block mb-1 text-yellow-700"></i>
              Usuario
            </button>
          </div>
        </div>
