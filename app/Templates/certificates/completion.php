<?php
/**
 * PLANTILLA DE CERTIFICADO DE CONCLUSIÓN/APROBACIÓN
 *
 ...
 *  $forumCode         string  - código del foro (ej: PROF-COL-SAB-0509)
 *  $forumTitle        string  - título completo del foro
 *  $dateIssued        string  - fecha emisión formateada
 *  $signatureDataUrl  string  - data URL de la firma del participante (PNG/SVG)
 *  $directorName      string  - nombre de la directora (default: María Luz Genovese)
 *  $directorSignature string  - data URL de la firma institucional (default SVG)
 */
...
<head>
    ...
    <title>Certificado de Conclusión - <?= htmlspecialchars($participantName, ENT_QUOTES) ?></title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .certificate {
            ...
            box-shadow: 0 20px 60px rgba(15, 58, 140, 0.25);
            position: relative;
            overflow: hidden;
        }
        .certificate::before {
            ...
            background:
                repeating-linear-gradient(45deg, transparent, transparent 35px, rgba(29, 78, 216, 0.08) 35px, rgba(29, 78, 216, 0.08) 70px);
            pointer-events: none;
        }
        .certificate::after {
            content: '';
        ...
        .btn-pdf { background: var(--accent-success); color: white; }
        @media print {
...
<body>
    ...
    <div class="certificate">
        <div class="content">
            <div class="header">
                ...
                <h1>Certificado</h1>
                <p class="subtitle">De Conclusión y Aprobación</p>
            </div>
            ...
            <div class="body">
                ...
                <p>ha completado satisfactoriamente el foro:</p>
            </div>
            ...
            <p style="margin-top: 24px; font-size: 14px; color: var(--neutral-text);">
                Habiendo cumplido con los requisitos de asistencia, participación activa<br>
                y validación de pago, se otorga este certificado en reconocimiento a su<br>
                dedicación al fortalecimiento de la salud mental comunitaria en LATAM.
            </p>

            <div class="seal">Aprobado · Foros PSME</div>
    ...
    function downloadPDF() {
        ...
        const filename = 'Certificado_Conclusion_<?= htmlspecialchars(preg_replace('/\s+/', '_', $participantName), ENT_QUOTES) ?>_' + new Date().toISOString().split('T')[0] + '.pdf';
        html2pdf().set({
            margin: 0,
            filename: filename,
